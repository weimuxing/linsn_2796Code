...
//--------------------------------------------------
#define _CHECKSUM                        	0X47//  0xEE
#define _VERSION_CODE                  		0x63//  0xAA
...
extern BYTE  inputsourceport[4];
extern WORD ColorTempRed;
extern WORD ColorTempGreen;
extern WORD ColorTempBlue;
extern BYTE ColorTempStatus;
...
code StructOsdInputPortDataType tOsdInputPortDataDefault[_OSD_INPUT_AMOUNT] =
{
    ...
    {   // _A0_INPUT_PORT
		...
		_OSD_ASPECT_RATIO_USER,		// _OSD_ASPECT_RATIO_ORIGIN ,//      _OSD_ASPECT_RATIO_FULL,     // BYTE b3AspectRatio : 3;
...
//---------------------------------------------------------------------------------------------
   ...
   _OSD_ASPECT_RATIO_USER,			//_OSD_ASPECT_RATIO_ORIGIN ,//      _OSD_ASPECT_RATIO_FULL,     // BYTE b3AspectRatio : 3;
    ...
    {   // _A0_INPUT_PORT
        0,                          // BYTE ucAspectOriginRatio
        2,                          // BYTE b3Sharpness : 3;
        _OSD_ASPECT_RATIO_ORIGIN,     // BYTE b3AspectRatio : 3;
        _ON,                        // BYTE b1OverScan : 1;
#if(_ULTRA_HDR_SUPPORT == _ON)
        _OFF,                       // b1DarkEnhanceStatus : 1;
        _HDR_MODE_OFF,              // BYTE ucHdrMode;
...
code StructOsdRegionDataType tOsdRegionDataDefault[_REGION_AMOUNT] =
{
    { // 1P
        ...
        _COLOREFFECT_STANDARD ,         		//_COLOREFFECT_MOVIE,                  // BYTE b4ColorEffect : 4;           //modify by john@20170522
        _CT_USER,								//_CT_SRGB,      							//_CT_6500,                               // BYTE b4ColorTempType : 4;
    ...
    { // PBP L
        ...
        _DEFAULT_HUE,                           // BYTE ucHue;
        _DEFAULT_SATURATION,                    // BYTE ucSaturation;
        _COLOREFFECT_STANDARD,   				//_COLOREFFECT_STANDARD,                  // BYTE b4ColorEffect : 4;   //modify by john@20170522
        _CT_USER,                  	 			//_CT_6500,                               // BYTE b4ColorTempType : 4;
        _GAMMA_22,                				//_GAMMA_OFF,                             // BYTE b3Gamma : 3;
        _PCM_OSD_NATIVE,                        // BYTE b3PCMStatus : 3;
        _OFF,                                   // BYTE b1PanelUniformity : 1;
        _ULTRA_VIVID_OFF,                       // BYTE b2UltraVividStatus : 2;
...
//StructOsdDisplayModeDataType tOsdDisplayModeDataDefault[_OSD_DM_AMOUNT] =
{
    { // _OSD_DM_1P
        _OSD_SR_1P_FULL,
        ...
        _OSD_INPUT_D4,                  // BYTE ucOsdInputPort3;
...
void RTDEepromLoadColorSetting(BYTE ucRegion)
{
    ...
    if(GET_OSD_GAMMA(ucRegion) != _GAMMA_OFF)
    {
		...
		{
			g_stColorProcData.usColorTempR = ColorTempRed;
	        g_stColorProcData.usColorTempG = ColorTempGreen;
	        g_stColorProcData.usColorTempB = ColorTempBlue;
		}
    }
    else
#endif
...
void RTDEepromRestoreOsdDisplayModeData(void)
{
    ...
    for(ucTemp = 0; ucTemp < _OSD_DM_AMOUNT; ucTemp++)
    {
		...
		g_stOsdDisplayModeData.ucOsdInputPort0 = inputsourceport[0];
		g_stOsdDisplayModeData.ucOsdInputPort1 = inputsourceport[1];
		g_stOsdDisplayModeData.ucOsdInputPort2 = inputsourceport[2];
		g_stOsdDisplayModeData.ucOsdInputPort3 = inputsourceport[3];
