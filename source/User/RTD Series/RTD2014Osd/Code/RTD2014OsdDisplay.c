...
void OsdDispMainMenuIconString(BYTE ucIconPos, WORD usIcon, BYTE ucColor)
{
    ...
    if((usIcon >= _ICON_A0_PORT) && (usIcon <= _ICON_D7_PORT))
             {
             #if ( _CHINESE_T_SUPPORT == _ON)
                if(GET_OSD_LANGUAGE() == _CHINESE_T)
                {
                    OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage,(usIcon-_ICON_INPUT_END +_STRIN_END), COLOR(ucColor, _CP_BG), _CHINESE_T);
                  }
             #else
             ...
             #endif
             #if ( _CHINESE_S_SUPPORT == _ON)
                  else if (GET_OSD_LANGUAGE() == _CHINESE_S)//繁体
                     {
                    OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage,(usIcon-_ICON_INPUT_END +_STRIN_END), COLOR(ucColor, _CP_BG), _CHINESE_S);
                     }
            #endif
            #if( _JAPANESE_SUPPORT ==_ON)
                else if (GET_OSD_LANGUAGE() == _JAPAN)//日语
                           {
                          OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage,(usIcon-_ICON_INPUT_END +_STRIN_END), COLOR(ucColor, _CP_BG), _JAPAN);
                           }
            #endif
            #if( _RUSSIAN_SUPPORT == _ON) 
                else if (GET_OSD_LANGUAGE() == _RUSSIAN)//俄语
                           {
                                OsdPropPutStringCenter( ucRow, ucCol, WIDTH(11), ucFontPage,(usIcon-_ICON_INPUT_END +_STRIN_END), COLOR(ucColor, _CP_BG), _RUSSIAN);
                             }
           #endif
           #if( _KOREAN_SUPPORT == _ON)
                else if (GET_OSD_LANGUAGE() == _KOREA)//韩语
                               {
                                    OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage,(usIcon-_ICON_INPUT_END +_STRIN_END), COLOR(ucColor, _CP_BG), _KOREA);
                                }
            ...
            if(GET_OSD_LANGUAGE() == _CHINESE_T)
               {
                  OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage, usIcon-1, COLOR(ucColor, _CP_BG), _CHINESE_T);
               }
            #else
             if(GET_OSD_LANGUAGE() == _ENGLISH)
               {
             ...
             #if(_CHINESE_S_SUPPORT ==_ON)
	             else if(GET_OSD_LANGUAGE() == _CHINESE_S)
	                   {
	                   OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage, usIcon-1, COLOR(ucColor, _CP_BG), _CHINESE_S);
	                   }
	    #endif
	        #if(  _JAPANESE_SUPPORT == _ON)
	             else if(GET_OSD_LANGUAGE() == _JAPAN)
	                   {
	                   OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage, usIcon-1, COLOR(ucColor, _CP_BG), _JAPAN);
	                   }
	        #endif
	        #if( _RUSSIAN_SUPPORT ==_ON)
	             else if(GET_OSD_LANGUAGE() == _RUSSIAN)
	                        {
	                       // OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage, usIcon-1, COLOR(ucColor, _CP_BG), _RUSSIAN);
	                 OsdPropPutStringCenter( ucRow, ucCol, WIDTH(11), ucFontPage, usIcon-1, COLOR(ucColor, _CP_BG), _RUSSIAN);
	                        }
	       #endif
	       #if(_KOREAN_SUPPORT ==_ON)
	             else if(GET_OSD_LANGUAGE() == _KOREA)
	                    {
	                    OsdPropPutStringCenter( ucRow, ucCol, WIDTH(10), ucFontPage, usIcon-1, COLOR(ucColor, _CP_BG), _KOREA);
	                    }
	        #endif
...
void OsdDispMainMenuIconPage(BYTE ucUpDown, BYTE ucState)
{
    ...
    switch(ucState)
    {
        ...
        case _ICON_PAGE_LANGUAGE_0:///
                 OsdDispMainOptionIcon((ucUpDown + 0), _ICON_ENGLISH, pucOsdItemColor[0]);
                 OsdDispMainOptionIcon((ucUpDown + 1), _ICON_CHINESE, pucOsdItemColor[1]);
                 OsdDispMainOptionIcon((ucUpDown + 2), _ICON_CHINESE_S, pucOsdItemColor[2]);
                 OsdDispMainOptionIcon((ucUpDown + 3), _ICON_JAPANESE, pucOsdItemColor[3]);
                 break;
                 
              case _ICON_PAGE_LANGUAGE_1:///第二页
                 OsdDispMainOptionIcon((ucUpDown + 0), _ICON_RUSSIAN, pucOsdItemColor[0]);
                 OsdDispMainOptionIcon((ucUpDown + 1), _ICON_KOREAN, pucOsdItemColor[1]);
...
void OsdDispMainMenuOptionSetting(BYTE ucItem, BYTE ucSelectState, BYTE ucOption)
{
    ...
    switch(ucItem)
    {
        ...
        case  _OPTION_LANGUAGE_TYPE:
        
                 if((ucOption == _ENGLISH) || (ucOption == _RUSSIAN))
              {
                  ucCol = COL(4) + ((_ITEM_0 % 4) * 10) - 2;
              }
                else if((ucOption == _CHINESE_T) || (ucOption == _KOREA))
              {
                  ucCol = COL(4) + ((_ITEM_1 % 4) * 10) - 2;
              }
                else if(ucOption == _CHINESE_S)
              {
                  ucCol = COL(4) + ((_ITEM_2 % 4) * 10) - 2;
              }
                else if(ucOption == _JAPAN)
              {
                  ucCol = COL(4) + ((_ITEM_3 % 4) * 10) - 2;
             }
        
        
                  if(GET_OSD_STATE() == _MENU_OTHER_LANGUAGE_ADJUST)
                         {
                             if(ucOption >= _RUSSIAN)
                             {
                                 OsdDispMainMenuArrow(_DOWN, _LEFT, _OSD_UNSELECT);
                                 OsdDispMainMenuArrow(_DOWN, _RIGHT, _OSD_REJECT);
                             }
...
void OsdDispSliderAndNumber(WORD usOsdState, WORD usValue)
{
    ...
    switch(usOsdState)
    {
        ...
        case _MENU_OTHER_LANGUAGE_ADJUST:
                   ...
                   g_usAdjustValue = OsdDisplayDetOverRange(g_usAdjustValue, _KOREA, _ENGLISH, _OFF);
                    SET_OSD_LANGUAGE(g_usAdjustValue);
                    OsdDispMainMenuOptionSetting(_OPTION_LANGUAGE_TYPE, _SELECT, GET_OSD_LANGUAGE());
    ...
    switch(enumMessage)
    {
        case _OSD_DISP_NOSIGNAL_MSG:
                 if(GET_OSD_LANGUAGE() == _CHINESE_T)  
                    ...
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                    // icon
                    OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SIGNAL_TEXT_CHS_0);
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                    OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SIGNAL_TEXT_CHS_1);
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                             ...
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                             // icon
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SIGNAL_TEXT_CHT_0);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SIGNAL_TEXT_CHT_1);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                             ...
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                             // icon
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SIGNAL_TEXT_JAP_0);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SIGNAL_TEXT_JAP_1);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                             ...
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                             // icon
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SIGNAL_TEXT_RUS_0);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SIGNAL_TEXT_RUS_1);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                             ...
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                             // icon
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SIGNAL_TEXT_KOR_0);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                             OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SIGNAL_TEXT_KOR_1);
                             OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
        ...
        case _OSD_DISP_NOCABLE_MSG:
             if(GET_OSD_LANGUAGE() == _CHINESE_T)  
                    ...
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                    // icon
                    OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_CABLE_TEXT_CHS_0);
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                    OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_CABLE_TEXT_CHS_1);
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                            }
                    else if(GET_OSD_LANGUAGE() == _CHINESE_S)  
                                         {
                           ...
                           OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                           // icon
                           OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_CABLE_TEXT_CHT_0);
                           OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                           OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_CABLE_TEXT_CHT_1);
                           OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                   }
                   else if(GET_OSD_LANGUAGE() == _JAPAN)  
                                                   {
                                     ...
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                                     // icon
                                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_CABLE_TEXT_JAP_0);
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_CABLE_TEXT_JAP_1);
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                             }
                         else if(GET_OSD_LANGUAGE() == _RUSSIAN)  
                                                                     {
                                       ...
                                       OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_0, _ICON_NO_CABLE);
                                         OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                                                       // icon
                                          OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_CABLE_TEXT_RUS_0);
                                        OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                                          OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_CABLE_TEXT_RUS_1);
                                         OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                                               }
                             else if(GET_OSD_LANGUAGE() == _KOREA)  
                                                     {
                                       ...
                                       OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_0, _ICON_NO_CABLE);
                                         OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                                                       // icon
                                          OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_CABLE_TEXT_KOR_0);
                                        OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                                          OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_CABLE_TEXT_KOR_1);
                                         OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                                               }
        ...
        case _OSD_DISP_NOSUPPORT_MSG:
                    ...
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                    // icon
                    OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SUPPORT_TEXT_CHS_0);
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                    OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SUPPORT_TEXT_CHS_1);
                    OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                      }
                     else if(GET_OSD_LANGUAGE() == _CHINESE_S)  
                                   {
                     ...
                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                     // icon
                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SUPPORT_TEXT_CHT_0);
                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SUPPORT_TEXT_CHT_1);
                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                       }
                     else if(GET_OSD_LANGUAGE() == _JAPAN)  
                                          {
                            ...
                            OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                            // icon
                            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SUPPORT_TEXT_JAP_0);
                            OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SUPPORT_TEXT_JAP_1);
                            OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                              }
                                     ...
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                                     // icon
                                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SUPPORT_TEXT_RUS_0);
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SUPPORT_TEXT_RUS_1);
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                                       }
                        else if(GET_OSD_LANGUAGE() == _KOREA)  
                                                   {
                                     ...
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                                     // icon
                                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_NO_SUPPORT_TEXT_KOR_0);
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                                     OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_NO_SUPPORT_TEXT_KOR_1);
                                     OsdFontPut1BitMainMenuIcon(ROW(2), COL(18 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                                                       }
        ...
        case _OSD_DISP_POWER_SAVING_MSG:
            ...
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
            // icon
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_POWER_SAVING_TEXT_CHS_0);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_POWER_SAVING_TEXT_CHS_1);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_3, _ICON_POWER_SAVING_TEXT_CHS_2);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6 + 6), (_1DYNAMIC_ICON_START + (3 * 24)), _CP_BLUE, _CP_BG);
                             }         
           else if(GET_OSD_LANGUAGE() == _CHINESE_S)  
                          {
            ...
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
            // icon
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_POWER_SAVING_TEXT_CHT_0);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_POWER_SAVING_TEXT_CHT_1);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_3, _ICON_POWER_SAVING_TEXT_CHT_2);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6 + 6), (_1DYNAMIC_ICON_START + (3 * 24)), _CP_BLUE, _CP_BG);
                             }
            ...
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
            // icon
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_POWER_SAVING_TEXT_JAP_0);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_POWER_SAVING_TEXT_JAP_1);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_3, _ICON_POWER_SAVING_TEXT_JAP_2);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6 + 6), (_1DYNAMIC_ICON_START + (3 * 24)), _CP_BLUE, _CP_BG);
                             }
              else  if(GET_OSD_LANGUAGE() == _RUSSIAN)  
                          {
            ...
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
            // icon
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_POWER_SAVING_TEXT_RUS_0);
           OsdFontPut1BitMainMenuIcon(ROW(2), COL(14), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_POWER_SAVING_TEXT_RUS_1);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
            OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_3, _ICON_POWER_SAVING_TEXT_RUS_2);
            OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6 + 6), (_1DYNAMIC_ICON_START + (3 * 24)), _CP_BLUE, _CP_BG);
                             }    
             else if(GET_OSD_LANGUAGE() == _KOREA)  
                                 {
                   ...
                   OsdFontPut1BitMainMenuIcon(ROW(2), COL(3), (_1DYNAMIC_ICON_START + (0 * 24)), _CP_WHITE, _CP_BG);
                   // icon
                   OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_1, _ICON_POWER_SAVING_TEXT_KOR_0);
                  OsdFontPut1BitMainMenuIcon(ROW(2), COL(14), (_1DYNAMIC_ICON_START + (1 * 24)), _CP_BLUE, _CP_BG);
                   OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_2, _ICON_POWER_SAVING_TEXT_KOR_1);
                   OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6), (_1DYNAMIC_ICON_START + (2 * 24)), _CP_BLUE, _CP_BG);
                   OsdFontVLCDynamicLoadIcon(_ICON_POS_UP_3, _ICON_POWER_SAVING_TEXT_KOR_2);
                   OsdFontPut1BitMainMenuIcon(ROW(2), COL(14 + 6 + 6), (_1DYNAMIC_ICON_START + (3 * 24)), _CP_BLUE, _CP_BG);
                                    }             
