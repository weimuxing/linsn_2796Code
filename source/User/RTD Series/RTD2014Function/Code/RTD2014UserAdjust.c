...
EnumDisplayRegion UserAdjustConvertDisplayRegion(BYTE ucRegion)
{
	DebugMessageSystem("ucRegion->",ucRegion);
    switch(GET_OSD_DISPLAY_MODE())
    {
        case _OSD_DM_1P:
			DebugMessageSystem("DISPLAY_MODE -> _OSD_DM_1P",_OSD_DM_1P);
            return _DISPLAY_RGN_1P;
            break;

        case _OSD_DM_2P_LR:
			DebugMessageSystem("DISPLAY_MODE -> _OSD_DM_2P_LR",_OSD_DM_2P_LR);
            if(ucRegion == _OSD_SR_2P_LR_L)
            {
        ...
        case _OSD_DM_2P_PIP:
			DebugMessageSystem("DISPLAY_MODE -> _OSD_DM_2P_PIP",_OSD_DM_2P_PIP);
            if(ucRegion == _OSD_SR_2P_PIP_MAIN)
            {
        ...
        case _OSD_DM_2P_TB:
			DebugMessageSystem("DISPLAY_MODE -> _OSD_DM_2P_TB",_OSD_DM_2P_TB);
            if(ucRegion == _OSD_SR_2P_TB_T)
            {
            ...
            break;
        case _OSD_DM_4P:
			DebugMessageSystem("DISPLAY_MODE -> _OSD_DM_4P",_OSD_DM_4P);
            switch(ucRegion)
            {
                case _OSD_SR_4P_LT_INSIDE:
                default:
