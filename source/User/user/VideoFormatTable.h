...
BYTE GetGS4911ByVideoFormat(BYTE format);
BYTE GetVideoFormatByGS4911(u8 format);
...
SWORD GetDlckByVideoFormat(BYTE format);
SWORD GetVideoFormat(int hde, int vde, int htotal, int vtotal, int vfreq);
...
SWORD IsInterlaceFormat(int format);

SWORD IsSDFormat(int format);

BYTE GetExtInputFormat(void);

BYTE getCustomTimming(int h_pixels,int v_lines,int freq);
