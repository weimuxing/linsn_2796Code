...
#define _PANEL_DV_TOTAL_MIN                     1091                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  190                 // Maxinum Pixel Clock in MHz
