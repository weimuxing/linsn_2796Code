...
//--------------------------------------------------
#define _PANEL_DISP_BIT_MODE                    _PANEL_DISP_30_BIT //_PANEL_DISP_24_BIT //modify 10bit john@20170117
...
#define _PANEL_POWER_OFF_T4                    200// 20                  // Panel Power Off T4 (ms)
#define _PANEL_POWER_OFF_T5                     40                  // Panel Power Off T5 (ms)
#define _PANEL_POWER_OFF_T6                    1000// 600                 // Panel Power Off T6 (ms)
