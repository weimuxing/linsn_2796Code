...
#define _CTSRGB_RED                                 (0x7a << 4)
#define _CTSRGB_GREEN                               (0x8a << 4)
#define _CTSRGB_BLUE                                (0x84 << 4)

#define _CTUSER_RED                                 (0x7f << 4)
#define _CTUSER_GREEN                               (0x8e << 4)
#define _CTUSER_BLUE                                (0x84 << 4)   //(0x80 << 4)
