...
void UserCommonInterfaceAdjustColorProc(EnumDisplayRegion enumDisplayRegion)
{
    ...
    {
        ScalerColorSetRGBLimitRange(enumSourceSearchPort, _TRUE);
    }
    else
    {
...
#if DEBUG_RS232
#if 0
BYTE EDID_BUF_DP_1080P[256] =
//BYTE code EDID_BUF_DP_1080P[256] =
{
...
BYTE EDID_BUF_DP_4K2K_30[256] =
//BYTE code EDID_BUF_DP_4K2K_30[256] =
{
...
BYTE EDID_BUF_DP_4K2K_60[256] = 
//BYTE code EDID_BUF_DP_4K2K_60[256] =
{
...
// A0 EDID-----------------------------------------------------------------------------------------------------------
        ...
        case _A0_INPUT_PORT_EDID:
			...
			DebugMessageSystem("_A0_EDID_TABLE_LOCATION_CODE",_EDID_TABLE_LOCATION_CODE);
			...
			DebugMessageSystem("_A0_EDID_TABLE_LOCATION_SYSTEM_EEPROM",_EDID_TABLE_LOCATION_CODE);
            UserCommonNVRamRead(_EDID_A0_ADDRESS_EEPROM, _A0_EMBEDDED_DDCRAM_SIZE, MCU_DDCRAM_A0);
#elif(_A0_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_FLASH)
			DebugMessageSystem("_A0_EDID_TABLE_LOCATION_FLASH",_EDID_TABLE_LOCATION_FLASH);
			...
			DebugMessageSystem("_A0_EDID_TABLE_LOCATION_USER",_EDID_TABLE_LOCATION_USER);
            UserInterfaceGetEmbeddedEDIDData(_A0_INPUT_PORT_EDID);
#endif
...
// D0 EDID-----------------------------------------------------------------------------------------------------------
        ...
        case _D0_INPUT_PORT_EDID:
			...
			DebugMessageSystem("_EDID_TABLE_LOCATION_CODE",_EDID_TABLE_LOCATION_CODE);
            //memcpy(MCU_DDCRAM_D0, tEDID_TABLE_D0, _D0_EMBEDDED_DDCRAM_SIZE);   //do not include .h file john@20170220
            memcpy(MCU_DDCRAM_D0, EDID_DP, _D0_EMBEDDED_DDCRAM_SIZE);
#elif(_D0_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_SYSTEM_EEPROM)
			DebugMessageSystem("_EDID_TABLE_LOCATION_SYSTEM_EEPROM",_EDID_TABLE_LOCATION_CODE);
            UserCommonNVRamRead(_EDID_D0_ADDRESS_EEPROM, _D0_EMBEDDED_DDCRAM_SIZE, MCU_DDCRAM_D0);
#elif(_D0_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_FLASH)
			DebugMessageSystem("_EDID_TABLE_LOCATION_FLASH",_EDID_TABLE_LOCATION_FLASH);
			...
			DebugMessageSystem("_EDID_TABLE_LOCATION_USER",_EDID_TABLE_LOCATION_USER);
