...
typedef struct 
{
	...
	u16 stFirstDisplayHehght;
	u16 stSecondDisplayWidth;
	u16 stSecondDisplayHehght;
	u16 stThirdDisplayWidth;
	u16 stThirdDisplayHehght;
	u16 stFourthDisplayWidth;
	u16 stFourthDisplayHehght;
...
typedef struct 
{
	u16 stPipMainWinPosX;
	u16 stPipMainWinPosY;
	u16 stPipMainWinSizeX;
	u16 stPipMainWinSizeY;

	u16 stPipSubWinPosX;
	u16 stPipSubWinPosY;
	u16 stPipSubWinSizeX;
	u16 stPipSubWinSizeY;

	u16 stPbpTopWinPosX;
	u16 stPbpTopWinPosY;
	u16 stPbpTopWinSizeX;
	u16 stPbpTopWinSizeY;

	u16 stPbpBomWinPosX;
	u16 stPbpBomWinPosY;
	u16 stPbpBomWinSizeX;
	u16 stPbpBomWinSizeY;

	u16 stPbpLeftWinPosX;
	u16 stPbpLeftWinPosY;
	u16 stPbpLeftWinSizeX;
	u16 stPbpLeftWinSizeY;

	u16 stPbpRightWinPosX;
	u16 stPbpRightWinPosY;
	u16 stPbpRightWinSizeX;
	u16 stPbpRightWinSizeY;
