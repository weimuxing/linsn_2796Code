...
#define SET_INPUT_TIMING_VFREQ(x)                    (g_pstRegionTimingInfoPointer->stTimingInfo.usVFreq = (x))

#define SET_INPUT_TIMING_VTOTAL(x)                   (g_pstRegionTimingInfoPointer->stTimingInfo.usVTotal = (x))


#define SET_INPUT_TIMING_H_POLARITY(x)				(g_pstRegionTimingInfoPointer->stTimingInfo.b1HSP = (x))
#define SET_INPUT_TIMING_V_POLARITY(x)				(g_pstRegionTimingInfoPointer->stTimingInfo.b1VSP = (x))
#define SET_INPUT_TIMING_INTERLACE_FLG(x)			(g_pstRegionTimingInfoPointer->stTimingInfo.b1Interlace = (x))
#define SET_INPUT_TIMING_HFREQ(x)                   (g_pstRegionTimingInfoPointer->stTimingInfo.usHFreq = (x))
#define SET_INPUT_TIMING_HSYNCWIDTH(x)              (g_pstRegionTimingInfoPointer->stTimingInfo.usHSWidth = (x))
#define SET_INPUT_TIMING_VSYNCWIDTH(x)              (g_pstRegionTimingInfoPointer->stTimingInfo.usVSWidth = (x))
