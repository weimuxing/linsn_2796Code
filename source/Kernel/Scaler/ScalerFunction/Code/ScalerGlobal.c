...
void ScalerGlobalAddPortMapping(EnumSourceSearchPort enumSourceSearchPort, EnumDisplayDataPath enumDisplayDataPath)
{
    ...
    stCmd.data_1 = 0x12;
    stCmd.data_2 = 0;
    stCmd.data_3 = enumSourceSearchPort;
    stCmd.data_4 = enumDisplayDataPath;
	SendRs232CommandSt(stCmd);

	buffer[0] = 21;
	buffer[1] = 22;
	buffer[2] = 23;
	buffer[3] = enumSourceSearchPort;
	buffer[4] = enumDisplayDataPath;
