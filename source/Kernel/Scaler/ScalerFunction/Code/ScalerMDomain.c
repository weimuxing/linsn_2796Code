...
StructFourPortSplit g_stFourPortSplitData;
PipWinSizeSt g_stPipWinData;

WORD MDouserHwidth = 3840;
WORD MDouserVheight = 2160;
WORD MDouserHstart = 0;
WORD MDouserVstart = 0;
...
void UserOutputParamInit(void)
{
	g_stFourPortSplitData.stActiveWidth = 3840;
	g_stFourPortSplitData.stActiveHeight = 2160;
	g_stFourPortSplitData.stFirstDisplayWidth = 0;
	g_stFourPortSplitData.stFirstDisplayHehght = 0;
	g_stFourPortSplitData.stSecondDisplayWidth = 0;
	g_stFourPortSplitData.stSecondDisplayHehght = 0;
	g_stFourPortSplitData.stThirdDisplayWidth = 0;
	g_stFourPortSplitData.stThirdDisplayHehght = 0;
	g_stFourPortSplitData.stFourthDisplayWidth = 0;
	g_stFourPortSplitData.stFourthDisplayHehght = 0;
	g_stFourPortSplitData.stFirstRegionWidthStart = 0;
	g_stFourPortSplitData.stFirstRegionHeightStart = 0;
	g_stFourPortSplitData.stSecondRegionWidthStart = 0;
	g_stFourPortSplitData.stSecondRegionHeightStart = 0;
}
