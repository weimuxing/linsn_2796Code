...
void ScalerDisplayLvdsTxDataSel(void)
{
	...
	else if(_LVDS_PORT_SEL == _LVDS_2_PORT_CD)
	{
	...
	else if(_LVDS_PORT_SEL == _LVDS_2_PORT_EF)
	{
	...
	else if(_LVDS_PORT_SEL == _LVDS_2_PORT_GH)
	{
	...
	else if(_LVDS_PORT_SEL == _LVDS_4_PORT_ABCD)
	{
	...
	else if(_LVDS_PORT_SEL == _LVDS_4_PORT_CDEF)
	{
	...
	else if(_LVDS_PORT_SEL == _LVDS_4_PORT_EFGH)
	{
	...
	else if(_LVDS_PORT_SEL == _LVDS_8_PORT_ABCDEFGH)
	{
	   #if 1 // #if 0  
	   ...
	   #else //modify LVDS order  01 45 23 67 john@20170118
	    ScalerSetByte(P39_02_LVDS_DISPLAY_CONV_CTRL1, 0x01);
	    ScalerSetByte(P39_03_LVDS_DISPLAY_CONV_CTRL2, 0x45);
	    ScalerSetByte(P39_04_LVDS_DISPLAY_CONV_CTRL3, 0x23);
	    ScalerSetByte(P39_05_LVDS_DISPLAY_CONV_CTRL4, 0x67);
	    #endif	
