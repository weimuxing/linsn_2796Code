...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_DEMO_A_1A1H4MHL1DP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6193_DEMO_A_1A1H4MHL1DP_DPTX_LVDS_eDP)
...
#define _A0_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_128
...
#define _D0_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_SYSTEM_EEPROM//_EDID_TABLE_LOCATION_CODE
...
#define _D1_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_NONE //_EDID_SIZE_256
...
#define _D3_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_256
...
// D4 Input Port
//--------------------------------------------------
#define _D4_INPUT_PORT_TYPE                     _D4_DUAL_DVI_PORT //_D4_HDMI_PORT   //john@2017011  _D4_DUAL_DVI_PORT
...
// D5 Input Port
//--------------------------------------------------
#define _D5_INPUT_PORT_TYPE                     _D5_NO_PORT //_D5_HDMI_PORT   //john@2017011
#define _D5_DDC_CHANNEL_SEL                     _DDC5
#define _D5_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_NONE  // _EDID_SIZE_256
...
#define _INPUT_PORT_SEARCH_PRI_5                _A0_INPUT_PORT
...
#define _INPUT_PORT_SEARCH_PRI_5                _D3_INPUT_PORT
#define _INPUT_PORT_SEARCH_PRI_6                _D5_INPUT_PORT
...
#define _LVDS_PORT_SEL                          _LVDS_2_PORT_EF//_LVDS_2_PORT_AB 	// _LVDS_2_PORT_GH//
...
#define _DDR3_PLL_INITIAL_PHASE_0               0x1B022600//0x1A042500 //0x26102E00//(Winboard test) //0x11001D00(demo board teet) //0x1C062A00( moren)
#define _DDR3_PLL_INITIAL_PHASE_1               0x1800271A//0x18002719 //0x24003325 //0x1A002010 //0x18002A1C
#define _DDR3_READ_DQ_DLYN_TAP                  0x1F1F1F1F//0x1F1F1F1F //0x1E1E1E1E// 0x20202020//0x20202020
...
// CBUS1/HDMI_HPD_3
#define _PIN_AB4                                (2 & 0x07) // Page 10-0x06[2:0]
...
// NC
#define _PIN_AE5                                (0 & 0x07) // Page 10-0x0E[2:0]
...
// KEY3
#define _PIN_AM2                                  (3 & 0x07) // Page 10-0x13[2:0]
...
// ADJBACKLITE
#define _PIN_AJ1                                (2 & 0x07) // Page 10-0x18[2:0]
// 0 ~ 6 (0: P5D0i<I>, 1: P5D0o<PP>, 2: P5D0o<OD>, 3: PWM1<PP>, 4: PWM1<OD>,
//        5: TCON[5], 6: INT0)

// NC (HDMI_MHL_SEL_1)
#define _PIN_AH2                                (0 & 0x07) // Page 10-0x19[2:0]
...
// NC
#define _PIN_AJ15                               (1 & 0x07) // Page 10-0x37[2:0]
...
// VBUS_EN_2
#define _PIN_AD29                               (1 & 0x07) // Page 10-0x3C[2:0]
// 0 ~ 6 (0: P9D4i<I>, 1: P9D4o<PP>, 2: P9D4o<OD>, 3: PWM4<PP>, 4: PWM4<OD>,
//        5: TCON[6], 6:T1)

// VBUS_EN_3
#define _PIN_AF29                               (1 & 0x07) // Page 10-0x3D[2:0]
...
// AUDIO_HOUTR
#define _PIN_AJ13                               (1 & 0x07) // Page 10-0x52[2:0]
...
// HDMI_MHL_SEL_5
#define _PIN_AK3                              (1 & 0x07) //    (2 & 0x07) // Page 10-0x57[2:0]
// 0 ~ 2 (0: PCD7i<I>, 1: PCD7o<PP>, 2: PCD7o<OD>)

// HDMI_MHL_SEL_4
#define _PIN_AK4                             (1 & 0x07) //    (2 & 0x07) // Page 10-0x58[2:0]
// 0 ~ 2 (0: PDD0i<I>, 1: PDD0o<PP>, 2: PDD0o<OD>)

// HDMI_MHL_SEL_3
#define _PIN_AJ3                                (2 & 0x07) // Page 10-0x59[2:0]
// 0 ~ 2 (0: PDD1i<I>, 1: PDD1o<PP>, 2: PDD1o<OD>)

// HDMI_MHL_SEL_2
#define _PIN_AJ4                                (2 & 0x07) // Page 10-0x5A[2:0]
// 0 ~ 2 (0: PDD2i<I>, 1: PDD2o<PP>, 2: PDD2o<OD>)

// HDMI_HPD_1
#define _PIN_AH3                                (2 & 0x07) // Page 10-0x5B[2:0]
...
//--------------------------------------------------
sbit bBACKLIGHTPOWER                            = P3 ^ 5; // Pin_AE6, P3.5
#define bBack							 (MCU_FE08_PORT50_PIN_REG) // P5D0o
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE31_PORTA1_PIN_REG) // Pin_AG28, PA.1
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    (MCU_FE33_PORTA3_PIN_REG)  // Pin_AH28, PA.3
#define bD0_DP_PIN16_CONNECT                    (MCU_FE35_PORTA5_PIN_REG)  // Pin_AH27, PA.5
#define bD0_DP_PIN17_CONNECT                    (MCU_FE34_PORTA4_PIN_REG)  // Pin_AE29, PA.4
...
#define bD1_CONNECT                             (MCU_FE46_PORTC6_PIN_REG) // Pin_AG7, PC.6
#define bD2_CONNECT                             (MCU_FE3B_PORTB3_PIN_REG) // Pin_AH24, PB.3
#define bD3_CONNECT                             (MCU_FE3A_PORTB2_PIN_REG) // Pin_AC29, PB.2
...
//-----------------------------------------------
sbit bD2_MHL_CONNECT                            = P1 ^ 5; // Pin_Y7, P1.5
sbit bD3_MHL_CONNECT                            = P1 ^ 7; // Pin_Y6, P1.7
#define bD4_MHL_CONNECT                         (MCU_FE5C_PORTF4_PIN_REG) // Pin_N5, PF.4
#define bD5_MHL_CONNECT                         (MCU_FE5A_PORTF2_PIN_REG) // Pin_N6, PF.2

#define PCB_D2_MHL_DETECT()                     (0)//(bD2_MHL_CONNECT)
#define PCB_D3_MHL_DETECT()                     (0)//(bD3_MHL_CONNECT)
#define PCB_D4_MHL_DETECT()                     (0)//(bD4_MHL_CONNECT)
#define PCB_D5_MHL_DETECT()                     (0)//(bD5_MHL_CONNECT)
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_FE4C_PORTD4_PIN_REG) // Pin_AH4, PD.4
#define bD1_HPD                                 (MCU_FE4B_PORTD3_PIN_REG) // Pin_AH3, PD.3
sbit bD2_HPD                                    = P1 ^ 4; // Pin_AB5, P1.4
sbit bD3_HPD                                    = P1 ^ 6; // Pin_AB4, P1.6
#define bD4_HPD                            (MCU_FE48_PORTD0_PIN_REG) // Pin_AK4, PD.0     (MCU_FE5B_PORTF3_PIN_REG) // Pin_A4, PF.3
#define bD5_HPD                            (MCU_FE47_PORTC7_PIN_REG) // Pin_AK3, PC.7        (MCU_FE59_PORTF1_PIN_REG) // Pin_A3, PF.1
...
//-----------------------------------------------
#define bD2_TMDS_SWITCH                         (MCU_FE4A_PORTD2_PIN_REG) // Pin_AJ4, PD.2
#define bD3_TMDS_SWITCH                         (MCU_FE49_PORTD1_PIN_REG) // Pin_AJ3, PD.1
#define bD4_TMDS_SWITCH                      (MCU_FE5B_PORTF3_PIN_REG) // Pin_A4, PF.3    (MCU_FE48_PORTD0_PIN_REG) // Pin_AK4, PD.0
#define bD5_TMDS_SWITCH                     (MCU_FE59_PORTF1_PIN_REG) // Pin_A3, PF.1    (MCU_FE47_PORTC7_PIN_REG) // Pin_AK3, PC.7
...
//-----------------------------------------------
#define bD2_MHL_VBUS_SWITCH                     (MCU_FE2C_PORT94_PIN_REG) // Pin_AD29, P9.4
#define bD3_MHL_VBUS_SWITCH                     (MCU_FE2D_PORT95_PIN_REG) // Pin_AF29, P9.5
...
#define PCB_KEY_STATE(ucV0, ucV1,\
                      ucV2, ucV3, ucKeyState)   {\
                                                    if((0xb8 <= (ucV1)) && ((ucV1) < 0xc0))\
                                                    {\
                                                        (ucKeyState) |= _LEFT_KEY_MASK;\
                                                    }\
                                                    if((0xb8 <= (ucV2)) && ((ucV2) < 0xc0))\
                                                    {\
                                                        (ucKeyState) |= _RIGHT_KEY_MASK;\
                                                    }\
                                                    if((0x78 <= (ucV2)) && ((ucV2) < 0x80))\
                                                    {\
                                                        (ucKeyState) |= _EXIT_KEY_MASK;\
                                                    }\
                                                    if((0x38 <= (ucV2)) && ((ucV2) < 0x40))\
                                                    {\
...
#define SYS_RSTART()    (MCU_FFEE_MCU_CLOCK_CONTROL |= _BIT1);

#endif // End of #if(_PCB_TYPE == _RL6193_DEMO_A_1A1H4MHL1DP_DPTX_LVDS_eDP)
