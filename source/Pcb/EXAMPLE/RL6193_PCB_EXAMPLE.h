...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_PCB_EXAMPLE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6193_PCB_EXAMPLE)
...
//--------------------------------------------------
#define _EXTERNAL_MEMORY_SIZE_CONFIG            _1G_16BIT_DDR3_1PC     // _1G_16BIT_DDR3_1PC
                                                                       // _1G_16BIT_DDR3_2PCS
                                                                       // _2G_16BIT_GDDR3_1PC
...
#define _PIN_AC6                                (0 & 0x07) // Page 10-0x08[2:0]
...
#define _PIN_AE6                                (0 & 0x07) // Page 10-0x0D[2:0]
...
#define _PIN_AL2                                (0 & 0x07) // Page 10-0x11[2:0]
// 0 ~ 4 (0: P4D1i<I>, 1: P4D1o<PP>, 2: P4D1o<OD>, 3: A-adc0_0, 4: Int0)

#define _PIN_AL1                                (0 & 0x07) // Page 10-0x12[2:0]
// 0 ~ 4 (0: P4D2i<I>, 1: P4D2o<PP>, 2: P4D2o<OD>, 3: A-adc1_0, 4: INT1)

#define _PIN_AM2                                (0 & 0x07) // Page 10-0x13[2:0]
...
#define _PIN_AG2                                (0 & 0x07) // Page 10-0x15[2:0]
// 0 ~ 3 (0: P4D5i<I>, 1: P4D5o<PP>, 2: P4D5o<OD>, 3: Ddcsclvga)

#define _PIN_AG1                                (0 & 0x07) // Page 10-0x16[2:0]
...
#define _PIN_AK1                                (0 & 0x07) // Page 10-0x1C[2:0]
// 0 ~ 5 (0: P5D4i<I>, 1: P5D4o<PP>, 2: P5D4o<OD>, 3: PWM5<PP>, 4: PWM5<OD>,
//        5: TCON[12])

#define _PIN_G5                                 (0 & 0x07) // Page 10-0x1D[2:0]
...
#define _PIN_AL11                               (0 & 0x07) // Page 10-0x4C[2:0]
// 0 ~ 4 (0: PBD4i<I>, 1: PBD4o<PP>, 2: PBD4o<OD>, 3: Line_inl, 4: Ws)

#define _PIN_AM11                               (0 & 0x07) // Page 10-0x4D[2:0]
// 0 ~ 4 (0: PBD5i<I>, 1: PBD5o<PP>, 2: PBD5o<OD>, 3: Line_inr, 4: Sck)

#define _PIN_AE14                               (0 & 0x07) // Page 10-0x4E[2:0]
// 0 ~ 4 (0: PBD6i<I>, 1: PBD6o<PP>, 2: PBD6o<OD>, 3: Audio_ref, 4: Mck)

#define _PIN_AJ12                               (0 & 0x07) // Page 10-0x4F[2:0]
...
#define _PIN_AJ13                               (0 & 0x07) // Page 10-0x52[2:0]
// 0 ~ 5 (0: PCD2i<I>, 1: PCD2o<PP>, 2: PCD2o<OD>, 3: Audio_houtr, 4: Sd3,
//        5: Spdif3)

#define _PIN_AJ6                                (0 & 0x07) // Page 10-0x53[2:0]
// 0 ~ 3 (0: PCD3i<I>, 1: PCD3o<PP>, 2: PCD3o<OD>, 3: Dptx_aux_ch_p)

#define _PIN_AK6                                (0 & 0x07) // Page 10-0x54[2:0]
// 0 ~ 3 (0: PCD4i<I>, 1: PCD4o<PP>, 2: PCD4o<OD>, 3: Dptx_aux_ch_n)

#define _PIN_AH7                                (0 & 0x07) // Page 10-0x55[2:0]
...
#define _PIN_AK3                                (0 & 0x07) // Page 10-0x57[2:0]
// 0 ~ 2 (0: PCD7i<I>, 1: PCD7o<PP>, 2: PCD7o<OD>)

#define _PIN_AK4                                (0 & 0x07) // Page 10-0x58[2:0]
...
#define _PIN_AH4                                (0 & 0x07) // Page 10-0x5C[2:0]
// 0 ~ 2 (0: PDD4i<I>, 1: PDD4o<PP>, 2: PDD4o<OD>)

#define _PIN_AG3                                (0 & 0x07) // Page 10-0x5D[2:0]
// 0 ~ 6 (0: PDD5i<I>, 1: PDD5o<PP>, 2: PDD5o<OD>, 3: PWM1<PP>, 4: PWM1<OD>,
//        5:TCON[7], 6:IICSCL2)

#define _PIN_AG4                                (0 & 0x07) // Page 10-0x5E[2:0]
...
#define bA2_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)
...
#define PCB_A1_PIN()                            (bA1_CONNECT)
#define PCB_A2_PIN()                            (bA2_CONNECT)
...
#endif // End of #if(_PCB_TYPE == _RL6193_PCB_EXAMPLE)
