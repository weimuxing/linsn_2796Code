...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_QA_B_1A1H4MHL1DP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _DDR3_PLL_INITIAL_PHASE_0               0x1B042700
#define _DDR3_PLL_INITIAL_PHASE_1               0x1800271B
...
// KEY2 //For Vby1 Tx
#define _PIN_AL2                                (2 & 0x07) // Page 10-0x11[2:0]
// 0 ~ 4 (0: P4D1i<I>, 1: P4D1o<PP>, 2: P4D1o<OD>, 3: A-adc0_0, 4: Int0)

// KEY3 //For Vby1 Tx
#define _PIN_AL1                                (2 & 0x07) // Page 10-0x12[2:0]
// 0 ~ 4 (0: P4D2i<I>, 1: P4D2o<PP>, 2: P4D2o<OD>, 3: A-adc1_0, 4: INT1)

// KEY4 //For DP TX TEST
#define _PIN_AM2                                (2 & 0x07) // Page 10-0x13[2:0]
// 0 ~ 3 (0: P4D3i<I>, 1: P4D3o<PP>, 2: P4D3o<OD>, 3: A-adc2_0)

// KEY5 //For Vby1 Tx
#define _PIN_AM1                                (0 & 0x07) // Page 10-0x14[2:0]
...
// NC // For DP TX TEST
#define _PIN_AJ1                                (0 & 0x07) // Page 10-0x18[2:0]
...
// KEY1 //For DP TX TEST
#define _PIN_AK2                                (2 & 0x07) // Page 10-0x1B[2:0]
...
// ADJBACKLITE
#define _PIN_AB29                               (3 & 0x07) // Page 10-0x3E[2:0]
...
// NC   //For Vby1 Tx
#define _PIN_AE29                               (2 & 0x07) // Page 10-0x44[2:0]
// 0 ~ 5 (0: PAD4i<I>, 1: PAD4o<PP>, 2: PAD4o<OD>, 3: TCON[12], 4: Sd3,
//        5: Spdif3)

// NC   //For Vby1 Tx
#define _PIN_AH27                               (2 & 0x07) // Page 10-0x45[2:0]
...
// LINE_INL //For Vby1 Tx
#define _PIN_AL11                               (2 & 0x07) // Page 10-0x4C[2:0]
// 0 ~ 4 (0: PBD4i<I>, 1: PBD4o<PP>, 2: PBD4o<OD>, 3: Line_inl, 4: Ws)

// LINE_INR //For Vby1 Tx
#define _PIN_AM11                               (2 & 0x07) // Page 10-0x4D[2:0]
...
// AUDIO_SOUTR  //For Vby1 Tx
#define _PIN_AK12                               (0 & 0x07) // Page 10-0x50[2:0]
// 0 ~ 5 (0: PCD0i<I>, 1: PCD0o<PP>, 2: PCD0o<OD>, 3: Audio_soutr, 4: Sd1,
//        5: Spdif1)

// AUDIO_HOUTL  //For Vby1 Tx
#define _PIN_AH13                               (0 & 0x07) // Page 10-0x51[2:0]
// 0 ~ 5 (0: PCD1i<I>, 1: PCD1o<PP>, 2: PCD1o<OD>, 3: Audio_houtl, 4: Sd2,
//        5: Spdif2)

// AUDIO_HOUTR  //For Vby1 Tx
#define _PIN_AJ13                               (2 & 0x07) // Page 10-0x52[2:0]
...
// NC   // For DP TX TEST
#define _PIN_AG3                                (2 & 0x07) // Page 10-0x5D[2:0]
// 0 ~ 6 (0: PDD5i<I>, 1: PDD5o<PP>, 2: PDD5o<OD>, 3: PWM1<PP>, 4: PWM1<OD>,
//        5:TCON[7], 6:IICSCL2)

// NC // For DP TX TEST
#define _PIN_AG4                                (2 & 0x07) // Page 10-0x5E[2:0]
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE32_PORTA2_PIN_REG) // Pin_AC28, PA.2
...
#define bD1_DP_PIN16_CONNECT                    (P3_7)                  // Pin_AE4, P3.7
...
//-----------------------------------------------
#define bD2_MHL_CONNECT                         (P1_5) // Pin_Y7, P1.5
#define bD3_MHL_CONNECT                         (P1_7) // Pin_Y6, P1.7
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_FE4B_PORTD3_PIN_REG) // Pin_AH3, PD.3
#define bD1_HPD                                 (MCU_FE4C_PORTD4_PIN_REG) // Pin_AH4, PD.4
#define bD2_HPD                                 (P1_4) // Pin_AB5, P1.4
#define bD3_HPD                                 (P1_6) // Pin_AB4, P1.6
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (P3_0) // Pin_AC6, P3.0
#define bLED2                                   (P3_1) // Pin_AC4, P3.1
#define bLED3                                   (P3_2) // Pin_AC5, P3.2
#define bLED4                                   (P3_3) // Pin_AD6, P3.3
#define bLED5                                   (P3_4) // Pin_AD5, P3.4
...
//-----------------------------------------------
#define bPOWER_KEY                              (MCU_FE0B_PORT53_PIN_REG) // Pin_AK2, P5.3
#define bMENU_KEY                               (MCU_FE01_PORT41_PIN_REG) // Pin_AL2, P4.1
#define bEXIT_KEY                               (MCU_FE02_PORT42_PIN_REG) // Pin_AL1, P4.2
#define bLEFT_KEY                               (MCU_FE03_PORT43_PIN_REG) // Pin_AM2, P4.3
#define bRIGHT_KEY                              (MCU_FE04_PORT44_PIN_REG) // Pin_AM1, P4.4
